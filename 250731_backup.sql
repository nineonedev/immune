...
-- dbus25br0immu4 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `nineonelabs` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nineonelabs`;

-- 테이블 dbus25br0immu4.nb_admin 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_admin` (
  ...
  PRIMARY KEY (`no`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='관리자 계정 관리';

-- 테이블 데이터 dbus25br0immu4.nb_admin:1 rows 내보내기
/*!40000 ALTER TABLE `nb_admin` DISABLE KEYS */;
INSERT INTO `nb_admin` (`no`, `sitekey`, `uid`, `upwd`, `uname`, `active_status`) VALUES
	(1, 'IMMUNE', 'tmaster', '937e8d5fbb48bd4949536cd65b8d35c426b80d2f830c5c308e2cdec422ae2244', '관리자', 'Y');
/*!40000 ALTER TABLE `nb_admin` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_banner 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_banner` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
  ...
  PRIMARY KEY (`no`),
  KEY `b_loc` (`b_loc`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='배너 관리';

-- 테이블 데이터 dbus25br0immu4.nb_banner:0 rows 내보내기
/*!40000 ALTER TABLE `nb_banner` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_banner` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_board 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_board` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
  ...
  PRIMARY KEY (`no`),
  KEY `IDX_NB_BOARD4` (`sitekey`,`board_no`)
) ENGINE=MyISAM AUTO_INCREMENT=106 DEFAULT CHARSET=utf8mb3 COMMENT='통합 게시판';

-- 테이블 데이터 dbus25br0immu4.nb_board:40 rows 내보내기
/*!40000 ALTER TABLE `nb_board` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `nb_board` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_board_category 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_board_category` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
  `board_no` int NOT NULL COMMENT '게시판 고유번호',
  ...
  PRIMARY KEY (`no`),
  KEY `IDX_NB_BOARD_CATEGORY` (`board_no`)
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 dbus25br0immu4.nb_board_category:18 rows 내보내기
/*!40000 ALTER TABLE `nb_board_category` DISABLE KEYS */;
INSERT INTO `nb_board_category` (`no`, `sitekey`, `board_no`, `name`, `sort_no`) VALUES
	...
	(24, 'IMMUNE', 16, '기타', 6);
/*!40000 ALTER TABLE `nb_board_category` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_board_comment 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_board_comment` (
  ...
  PRIMARY KEY (`no`),
  KEY `IDX_NB_BOARD_COMMENT` (`parent_no`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 dbus25br0immu4.nb_board_comment:0 rows 내보내기
/*!40000 ALTER TABLE `nb_board_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_board_comment` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_board_lev_manage 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_board_lev_manage` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
  `board_no` int NOT NULL COMMENT '게시판 고유번호',
  ...
  PRIMARY KEY (`no`),
  KEY `IDX_NB_BOARD_LEV_MANAGE` (`board_no`,`lev_no`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 dbus25br0immu4.nb_board_lev_manage:0 rows 내보내기
/*!40000 ALTER TABLE `nb_board_lev_manage` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_board_lev_manage` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_board_manage 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_board_manage` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
...
-- 테이블 데이터 dbus25br0immu4.nb_board_manage:8 rows 내보내기
/*!40000 ALTER TABLE `nb_board_manage` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `nb_board_manage` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_counter 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_counter` (
...
-- 테이블 데이터 dbus25br0immu4.nb_counter:0 rows 내보내기
/*!40000 ALTER TABLE `nb_counter` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_counter` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_counter_config 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_counter_config` (
  `uid` int NOT NULL AUTO_INCREMENT,
...
-- 테이블 데이터 dbus25br0immu4.nb_counter_config:0 rows 내보내기
/*!40000 ALTER TABLE `nb_counter_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_counter_config` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_counter_data 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_counter_data` (
  `uid` int NOT NULL AUTO_INCREMENT,
  `Year` int NOT NULL DEFAULT '0',
  `Month` int NOT NULL DEFAULT '0',
  `Day` int NOT NULL DEFAULT '0',
...
-- 테이블 데이터 dbus25br0immu4.nb_counter_data:0 rows 내보내기
/*!40000 ALTER TABLE `nb_counter_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_counter_data` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_counter_route 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_counter_route` (
  `uid` int NOT NULL AUTO_INCREMENT,
  `Connect_Route` varchar(255) NOT NULL DEFAULT '',
  `Time` int NOT NULL DEFAULT '0',
...
-- 테이블 데이터 dbus25br0immu4.nb_counter_route:0 rows 내보내기
/*!40000 ALTER TABLE `nb_counter_route` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_counter_route` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_data 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_data` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
  ...
  PRIMARY KEY (`no`),
  KEY `IDX_NB_DATA1` (`sitekey`,`target`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 dbus25br0immu4.nb_data:0 rows 내보내기
/*!40000 ALTER TABLE `nb_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_data` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_member 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_member` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
  ...
  PRIMARY KEY (`no`),
  KEY `IDX_NB_MEMBER` (`lev`,`campus`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 dbus25br0immu4.nb_member:0 rows 내보내기
/*!40000 ALTER TABLE `nb_member` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_member` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_member_level 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_member_level` (
  `no` int NOT NULL AUTO_INCREMENT,
...
-- 테이블 데이터 dbus25br0immu4.nb_member_level:0 rows 내보내기
/*!40000 ALTER TABLE `nb_member_level` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_member_level` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_popup 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_popup` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
...
-- 테이블 데이터 dbus25br0immu4.nb_popup:2 rows 내보내기
/*!40000 ALTER TABLE `nb_popup` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `nb_popup` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_request 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_request` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
...
-- 테이블 데이터 dbus25br0immu4.nb_request:0 rows 내보내기
/*!40000 ALTER TABLE `nb_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `nb_request` ENABLE KEYS */;

-- 테이블 dbus25br0immu4.nb_siteinfo 구조 내보내기
CREATE TABLE IF NOT EXISTS `nb_siteinfo` (
  `no` int NOT NULL AUTO_INCREMENT,
  `sitekey` varchar(6) NOT NULL COMMENT '사이트 유니크 키',
...
-- 테이블 데이터 dbus25br0immu4.nb_siteinfo:1 rows 내보내기
/*!40000 ALTER TABLE `nb_siteinfo` DISABLE KEYS */;
INSERT INTO `nb_siteinfo` (`no`, `sitekey`, `title`, `phone`, `hp`, `fax`, `email`, `customercenter_able_time`, `company_able_time`, `google_map_key`, `logo_top`, `logo_footer`, `footer_name`, `footer_address`, `footer_phone`, `footer_hp`, `footer_fax`, `footer_email`, `footer_owner`, `footer_ssn`, `footer_policy_charger`, `meta_keywords`, `meta_description`, `meta_thumb`, `meta_favicon_ico`) VALUES
	(4, 'IMMUNE', '면력한방병원', 'https://www.youtube.com/@immune-rj6mx/featured', '', '', '', '', '', '', '687df188b985d8.79816702.svg', '687df188b99d40.43641209.svg', '면력한방병원', '서울 강서구 마곡중앙6로 93 열린프라자 6층, 7층, 10층', '1588-2915', '', '', '', '황이준', '645-92-01641 ', '', '', '', '687df1b2e95748.25055776.png', '687df188b9af70.90215450.png');
/*!40000 ALTER TABLE `nb_siteinfo` ENABLE KEYS */;
