                    ...
                    <div class="no-toolbar-container">
                        <div class="no-card">
                            ...
                            <div class="no-card-body no-admin-column no-admin-column--detail">
                                    ...
                                    <div class="no-admin-content">
                                        <div class="no-radio-form no-radio-flex">
                                            ...
                                            <div class="no-admin-content no-admin-date no-pd no-flex-row">
                                                <input type="text" name="b_sdate" id="b_sdate" class="b_date"
                                                    disabled />
                                                <span></span>
                                                <input type="text" name="b_edate" id="b_edate" class="b_date"
                                                    disabled />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="no-file-control">
                                            ...
                                            <div class="no-file-box">
                                                <input type="file" name="b_img" id="b_img"
                                                    onchange="javascript:document.getElementById('fake_banner_file').value = this.value" />
                                ...
                                <div class="no-admin-block">
                                    <h3 class="no-admin-title"><label for="b_desc">설명글</label></h3>
                                    <div class="no-admin-content">
                                            ...
                                            <label for="input5">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="b_target" id="input5" value="_none"
                                                        checked onClick="doHideDiv('no_linkaddress');" />
                                                    <span><i class="bx bx-radio-circle-marked"></i></span>
                                                </div>
