                    ...
                    <div class="no-card">
                        ...
                        <div class="no-card-body no-admin-column no-admin-column--detail">
                            ...
                            <div class="no-admin-block">
                                ...
                                <div class="no-admin-content">
                                    <input type="text" value="<?= htmlspecialchars($data['feces_time']) ?>" readonly>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="no-admin-block">
                                ...
                                <div class="no-admin-content">
                                    <input type="text" value="<?= htmlspecialchars($data['urine_time']) ?>" readonly>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="no-admin-block">
                                ...
                                <div class="no-admin-content">
                                    <div class="no-radio-form no-list">
                                        ...
                                        <label>
                                            <div class="no-radio-box">
                                                <input type="radio" name="swelling_area" value="<?= $key ?>" disabled
                                                    <?= $data['swelling_area'] == $key ? 'checked' : '' ?>>
                                                <span><i class="bx bx-radio-circle-marked"></i></span>
                                            </div>
                                            <span class="no-radio-text"><?= htmlspecialchars($label) ?></span>
                                        </label>
                            ...
                            <div class="no-admin-block">
                                ...
                                <div class="no-admin-content">
                                    <div class="no-radio-form no-list">
                                        ...
                                        <label>
                                            <div class="no-radio-box">
                                                <input type="radio" name="swelling_time" value="<?= $key ?>" disabled
                                                    <?= $data['swelling_time'] == $key ? 'checked' : '' ?>>
                                                <span><i class="bx bx-radio-circle-marked"></i></span>
                                            </div>
                                            <span class="no-radio-text"><?= htmlspecialchars($label) ?></span>
                                        </label>
                            ...
                            <div class="no-admin-block">
                                ...
                                <div class="no-admin-content">
                                    <div class="no-radio-form no-list">
                                        ...
                                        <label>
                                            <div class="no-radio-box">
                                                <input type="radio" name="miscarriage_exp" value="<?= $key ?>" disabled
                            ...
                            <div class="no-admin-block">
                                ...
                                <div class="no-admin-content">
                                    <div class="no-radio-form no-list">
                                        ...
                                        <label>
                                            <div class="no-radio-box">
                                                <input type="radio" name="menstrual_status" value="<?= $key ?>" disabled
                            ...
                            <div class="no-items-center center">
                                <a href="./prescription.php" class="no-btn no-btn--big no-btn--normal">목록</a>
                            </div>
                        </div>
