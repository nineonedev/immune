...
INSERT INTO `nb_banners` (`id`, `title`, `banner_type`, `is_active`, `start_at`, `end_at`, `description`, `has_link`, `link_url`, `duration`, `banner_image`, `branch_id`, `created_at`, `updated_at`, `sort_no`) VALUES
(1, 'ㅁㄴㅇㅁㄴㅇ', 0, 1, '', '', '', 2, '', 0, '', NULL, '2025-08-05 07:12:01', '2025-08-05 07:12:01', 0),
(2, '배너입니다.', 2, 1, '2025-08-05', '2025-08-14', '설명글입니다.', 1, 'naver.com', 1, '6891b5aba35786.28614343.png', 2, '2025-08-05 07:17:40', '2025-08-05 07:41:31', 0),
(3, '배너입니다.', 2, 1, '2025-08-04', '2025-08-14', '설명글입니다.', 1, 'naver.com', 1, '6891b41cda7e56.81374070.png', 2, '2025-08-05 07:34:52', '2025-08-05 07:34:52', 1),
(4, '배너입니다.', 2, 1, '2025-08-04', '2025-08-14', '설명글입니다.', 1, 'naver.com', 1, '6891b42e6e54b4.47642860.png', 2, '2025-08-05 07:35:10', '2025-08-05 07:35:10', 1);
...
CREATE TABLE `nb_popups` (
  ...
  `is_active` int DEFAULT '1' COMMENT '전역 변수 $is_active의 값 (0=숨김, 1=노출)',
  `start_at` datetime DEFAULT NULL COMMENT '노출 시작일시',
  `end_at` datetime DEFAULT NULL COMMENT '노출 종료일시',
  `description` text COMMENT '설명글',
  `has_link` int DEFAULT '2' COMMENT '전역 변수 $has_link의 값 (1=링크, 2=비링크)',
  `link_url` varchar(1024) DEFAULT NULL COMMENT '링크 URL',
  `duration` int DEFAULT '6' COMMENT '지속 시간 (초)',
...
ALTER TABLE `nb_popups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_nb_popups_branch` (`branch_id`);
...
--
ALTER TABLE `nb_popups`
  ADD CONSTRAINT `fk_nb_popups_branch` FOREIGN KEY (`branch_id`) REFERENCES `nb_branches` (`id`) ON DELETE SET NULL;
