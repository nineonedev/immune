...
(11, 2, 'cancer/female-1.php', '암면역센터', '유방·자궁·난소암 수술 전후 한방 케어', '수술 전후 체력 저하, 감염 위험, 상처 회복 등 다양한 문제를 예방하고 개선하는 여성암 수술 전후 한방치료 프로그램. 빠른 회복과 면역 증진을 동시에.', '여성암 수술, 유방암 수술 후, 자궁암 회복, 수술 후 한방치료, 면역력 강화, 한방 케어, 수술 회복, 수술 후유증', '2025-08-07 01:01:38', '2025-08-07 08:45:29', '유방·자궁·난소암', '수술 전 후'),
