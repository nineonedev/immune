                ...
                <div class="mobile-visual-wrap">
                    ...
                    <div class="no-cancer-sub">
                        ...
                        <section class="no-cancer-sub-food no-pd-48--y">
                            <div class="no-container-sm">
                                <h2 class="no-heading-sm --tac fade-up">대장암 치료식이</h2>
                                    ...
                                    <li class="no-pd-32--b">
                                        ...
                                        <ul class="dept2">
                                            <li>
                                                ...
                                                <p class="no-body-md fw300">식이섬유가 풍부한 식품 <span class="no-body-xs">(수술 후 식이섬유 주의)</span></p>
                                            </li>

                                            <li>
                                                <i class="fa-solid fa-check i-24 brown"></i>
                                                <p class="no-body-md fw300">저지방 단백질 <span class="no-body-xs">(닭고기, 생선)</span></p>
                                            </li>

                                            <li>
                                                <i class="fa-solid fa-check i-24 brown"></i>
                                                <p class="no-body-md fw300">충분한 수분</p>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="no-mg-32--t">
                                        ...
                                        <ul class="dept2">
                                            <li>
                                                ...
                                                <p class="no-body-md fw300">고지방, 가공식품</p>
                                            </li>

                                            <li>
                                                <i class="fa-solid fa-minus i-24" style="color: #d3d3d3;"></i>
                                                <p class="no-body-md fw300">너무 매운 음식</p>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                                ...
                                <figure class="no-mg-32--y fade-up">
                                    <img src="/resource/images/cancer-food-data2.jpg">
                                </figure>

                                <strong class="no-body-lg fw600 --tac fade-up">
                                    대장 내 종양이나 염증 등의 질환으로<br> 대장을 절제한 환자들에게, 빠른 회복을 돕습니다.
                                </strong>

                                <strong class="no-body-lg fw600 --tac fade-up no-mg-32--t">
                                    또한 <b class="brown">수술과 관련된 합병증을 예방</b>하며, 원인 질환의 <b class="brown">재발을 방지하기 위한 적절한 영양을 제공</b>합니다.
                                </strong>

                                <h2 class="no-heading-sm --tac fade-up no-mg-64--t">위암 치료식이</h2>

                                <img src="/resource/images/cancer-heal7-3.png" class="no-mg-32--y fade-up">
                                ...
                                <ul class="point-list fade-up">
                                    <li class="no-pd-32--b">
                                        ...
                                        <ul class="dept2">
                                            <li>
                                                <i class="fa-solid fa-check i-24 brown"></i>
                                                <p class="no-body-md fw300">소화가 쉬운 식품 <span class="no-body-xs">(쌀, 바나나, 삶은 채소)</span></p>
                                            </li>

                                            <li>
                                                <i class="fa-solid fa-check i-24 brown"></i>
                                                <p class="no-body-md fw300">단백질 보충 식품 <span class="no-body-xs">(단백질이 풍부한 식품)</span></p>
                                            </li>

                                            <li>
                                                <i class="fa-solid fa-check i-24 brown"></i>
                                                <p class="no-body-md fw300">작은 끼니</p>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="no-mg-32--t">
                                        ...
                                        <ul class="dept2">
                                            <li>
                                                <i class="fa-solid fa-minus i-24" style="color: #d3d3d3;"></i>
                                                <p class="no-body-md fw300">기름진 음식</p>
                                            </li>

                                            <li>
                                                <i class="fa-solid fa-minus i-24" style="color: #d3d3d3;"></i>
                                                <p class="no-body-md fw300">자극적인 양념과 조미료</p>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>

                                <ul class="food-list no-mg-32--y fade-up">
                                    <li>
                                        <figure>
                                            <img src="/resource/images/cancer-food2-1.jpg">
                                        </figure>

                                        <h3 class="no-body-md fw600 no-mg-4--t --tac">조식</h3>
                                    </li>

                                    <li>
                                        <figure>
                                            <img src="/resource/images/cancer-food2-2.jpg">
                                        </figure>

                                        <h3 class="no-body-md fw600 no-mg-4--t --tac">조식 간식</h3>
                                    </li>

                                    <li>
                                        <figure>
                                            <img src="/resource/images/cancer-food2-3.jpg">
                                        </figure>

                                        <h3 class="no-body-md fw600 no-mg-4--t --tac">중식</h3>
                                    </li>

                                    <li>
                                        <figure>
                                            <img src="/resource/images/cancer-food2-4.jpg">
                                        </figure>

                                        <h3 class="no-body-md fw600 no-mg-4--t --tac">중식 간식</h3>
                                    </li>

                                    <li>
                                        <figure>
                                            <img src="/resource/images/cancer-food2-5.jpg">
                                        </figure>

                                        <h3 class="no-body-md fw600 no-mg-4--t --tac">석식</h3>
                                    </li>

                                    <li>
                                        <figure>
                                            <img src="/resource/images/cancer-food2-6.jpg">
                                        </figure>

                                        <h3 class="no-body-md fw600 no-mg-4--t --tac">석식 간식</h3>
                                    </li>
                                </ul>

                                <strong class="no-body-lg fw600 --tac fade-up">
                                    위 절제 수술 직후부터 약 3개월 정도<br> 기간 동안 음식물이 장내로 빨리 내려가게 됩니다.
                                </strong>

                                <strong class="no-body-lg fw600 --tac fade-up no-mg-32--t">
                                    구토, 복통, 설사 등과 같은 증상이 나타나는 것을<br> 방지하고 <b class="brown">수술 후의 회복과 좋은 영양 상태를 유지하기 위한 식사를 제공</b>합니다.
                                </strong>
                            </div>
                        </section>
