            ...
            <div class="visual-wrap">
                ...
                <div class="mobile-visual-wrap">
                    ...
                    <div class="no-cancer-sub">
                            ...
                            <ul class="heal-list no-mg-32--t">
                                ...
                                <li class="updown-content">
                                    ...
                                    <div class="content v2 v3">
                                        ...
                                        <a href="/gangseo/pages/cancer/etc-4.php" class="basic-btn cancer no-body-lg fw600 no-mg-16--t">
                                            항암식이 바로가기
                                        </a>
                                    </div>
                                </li>
                        ...
                        <section class="no-cancer-graph v2 no-pd-48--y">
                            <div class="no-container-sm">
                        ...
                        <section class="no-cancer-graph no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <a href="/gangseo/pages/cancer/etc-3.php" class="basic-btn cancer no-body-lg fw600 no-mg-32--t">
                                    전이재발관리 이어서 보기
