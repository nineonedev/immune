                    ...
                    <div class="no-cancer-sub">
                            ...
                            <div class="no-container-sm">
                                ...
                                <ul class="ba-list list-js no-mg-40--t">
                                    ...
                                    <li class="--tac">
                                        ...
                                        <p class="no-body-md fw300">수술 부작용 관리</p>
                                    </li>
                                </ul>
                            </div>
                        </section>
                            ...
                            <ul class="disease-list">
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">발열</h3>
                                ...
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">림프부종</h3>
                                ...
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">배뇨 배변장애</h3>
                                ...
                                <li class="updown-content">
                                    ...
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease4.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">환자의 수술 부위 관리가 올바르게 이루어지지 않은 경우, 혹은 영양장애(당뇨), 감염 등으로 인하여 수술부위 염증이 생기고 상처가 아물지 않는 경우가 있습니다. 특히 고열을 동반하는경우 빠른 처치가 중요합니다.</p>
                                    </div>
                                </li>

                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">수술 후 유착으로 운동 제한</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease5.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">유방암 수술 부위 유착으로 인해 어깨 관절 움직임 제한으로 인한 관절 경직이 발생할 수 있습니다. 수술 후 환자 상태에 따라서 점진적으로 재활운동을 시작하여야 합니다.</p>
                                    </div>
                                </li>
                        ...
                        <section class="no-cancer-sub-care no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <ul class="care-list fade-up">
                                    <li class="mini-modal">
                                        <a href="#" onclick="return false">
                                            <h3 class="no-body-lg fw600">배액관 관리</h3>
                                            <i class="fa-regular fa-angle-up fa-rotate-90 i-24"></i>

                                            <img src="/resource/images/icon/cancer-care1.svg">
                                        </a>
                                            ...
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-5.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-6.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-7.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-8.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card1-9.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li class="mini-modal">
                                        <a href="#" onclick="return false">
                                            <h3 class="no-body-lg fw600">목욕 등 일상관리</h3>
                                            <i class="fa-regular fa-angle-up fa-rotate-90 i-24"></i>

                                            <img src="/resource/images/icon/cancer-care3.svg">
                                        </a>
                                        ...
                                        <div class="mini-modal-wrap">
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card3-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card3-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card3-3.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li class="mini-modal">
                                        <a href="#" onclick="return false">
                                            <h3 class="no-body-lg fw600">자세관리</h3>
                                            <i class="fa-regular fa-angle-up fa-rotate-90 i-24"></i>

                                            <img src="/resource/images/icon/cancer-care4.svg">
                                        </a>
                                        ...
                                        <div class="mini-modal-wrap">
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card4-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card4-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card4-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card4-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card4-5.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card4-6.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <section class="no-cancer-sub-end no-pd-48--b">
                            <div class="no-container-sm">
                                ...
                                <a href="/gangseo/pages/cancer/female-2.php" class="basic-btn cancer no-body-lg fw600 no-mg-32--t">
                                    항암방사선 이어서 보기
