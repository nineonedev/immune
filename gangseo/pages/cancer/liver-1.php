                    ...
                    <div class="no-cancer-sub">
                        ...
                        <section class="no-cancer-sub-ba no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <ul class="ba-list list-js no-mg-40--t v2">
                                    <li class="--tac">
                                        <h3 class="no-body-lg fw600 brown">간암</h3>

                                        <p class="no-body-md fw300">간기능 수치, 복수, 감염, 금주</p>
                                    </li>

                                    <li class="--tac">
                                        <h3 class="no-body-lg fw600 brown">담도암</h3>

                                        <p class="no-body-md fw300">황달, 담즙 배출, 지방변</p>
                                    </li>

                                    <li class="--tac">
                                        <h3 class="no-body-lg fw600 brown">췌장암</h3>

                                        <p class="no-body-md fw300">효소제 복용, 체중감소, 당뇨</p>
                                    </li>
                                </ul>
                            </div>
                        </section>
                            ...
                            <ul class="disease-list">
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">간부전</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease13-1.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">수술 후 간 용적의 부족, 혈액 흐름 저하, 담도 폐쇄, 복강 내 감염 등이 위험 인자가 될 수 있습니다. 전신 소양감(가려움증), 설사, 고열, 식욕부진, 구토, 황달 등의 증상이 나타납니다.</p>
                                    </div>
                                </li>
                                ...
                                <li class="updown-content">
                                    ...
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease13-2.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">수술 상처 부위에 감염이나 출혈이 발생할 수 있으며, 수술 부위의 발적, 부종, 통증, 분비물, 출혈 등이 나타납니다.
                                            대부분은 적절한 약물치료나 간단한 시술로 회복 가능합니다.</p>
                                    </div>
                                </li>

                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">담즙유출</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease13-3.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">수술 후 담즙이 흘러나와 복통, 발열, 황달 등의 증상이 발생할 수 있습니다.
                                            일시적인 경우가 많으며 적절한 치료로 대부분 회복됩니다.</p>
                                    </div>
                                </li>

                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">소화장애 및 영양흡수 장애</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease13-4.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">췌장의 일부나 전체를 절제하면 소화액(소화효소)이 충분히 분비되지 못해 음식물 소화에 문제가 생깁니다.
                                            이로 인해 복통, 설사, 복부 팽만감, 지방변 등이 발생하고 영양 흡수가 저하될 수 있습니다.</p>
                                    </div>
                                </li>

                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">당뇨</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <figure>
                                            <img src="/resource/images/cancer-disease13-5.jpg">
                                        </figure>

                                        <p class="no-body-md fw300 no-mg-16--t">
                                            <b class="fw600">원인</b><br>
                                            담도 문합 부위에서 담즙이 복강 내로 새는 현상<br><br>
                                            ...
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card25-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card25-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card25-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card25-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card25-5.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <section class="no-cancer-sub-end no-pd-48--b">
                            <div class="no-container-sm">
                                ...
                                <a href="/gangseo/pages/cancer/liver-2.php" class="basic-btn cancer no-body-lg fw600 no-mg-32--t">
                                    항암방사선 이어서 보기
