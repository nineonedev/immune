                    ...
                    <div class="no-cancer-sub">
                            ...
                            <ul class="disease-list">
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">호흡곤란 & 폐활량 감소</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            수술로 폐 일부(엽 또는 전폐)를 절제하면서 폐활량 감소 → 산소 교환 능력 저하특히, 고령·기저 폐 질환(COPD) 동반 시 더 뚜렷<br>
                                            <b class="fw600">증상</b><br>
                                            계단 오를 때 숨참, 말하면서 숨 고르기 어려움
                                        </p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease14-1.jpg">
                                        </figure>
                                        ...
                                        <p class="bullet no-body-md fw300">체위 조절 : 상체 살짝 세우고 쉬기</p>
                                        <p class="bullet no-body-md fw300">실내 환기 & 미세먼지 피하기</p>

                                        <span class="no-body-md fw600 brown no-mg-16--t">! 숨참이 심하거나 휘파람 호흡 발생 시 즉시 진료</span>
                                    </div>
                                </li>

                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">기침, 가래, 흉통</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            기관지 자극, 절개 부위 염증, 가래 정체<br>
                                            <b class="fw600">증상</b><br>
                                            잔기침, 심한 기침, 절개부위 당김, 묵직한 통증, 가래 뱉기 어려움
                                        </p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease14-2.jpg">
                                        </figure>
                                        ...
                                        <span class="no-body-md fw600 brown no-mg-16--t">! 발열 동반 시 감염 여부 확인 필요</span>
                                    </div>
                                </li>

                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">체력 저하, 활동 제한</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            폐기능 감소, 활동량 저하, 근육량 손실<br>
                                            <b class="fw600">증상</b><br>
                                            금방 피곤함, 외출 후 극심한 피로, 일상활동(청소, 장보기 등) 어려움
                                        </p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease14-3.jpg">
                                        </figure>

                                        <span class="no-body-md fw600">관리법</span>
                                        <p class="bullet no-body-md fw300">회복기 걷기 운동 (하루 10~30분 → 점차 증가)</p>
                                        <p class="bullet no-body-md fw300">균형 잡힌 식사로 기초 체력 보충</p>
                                        <p class="bullet no-body-md fw300">충분한 수면 (낮잠은 30분 이내)</p>
                                        <p class="bullet no-body-md fw300">피로 일지 작성하여 회복 경과 관찰</p>
                                    </div>
                                </li>
                        ...
                        <section class="no-cancer-sub-care no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <ul class="care-list fade-up">
                                    <li class="mini-modal">
                                        <a href="#" onclick="return false">
                                            <h3 class="no-body-lg fw600">폐활량 훈련</h3>
                                            ...
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card26-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card26-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card26-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card26-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card26-5.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card26-6.jpg">
                                                    </li>
                        ...
                        <section class="no-cancer-sub-end no-pd-48--b">
                            <div class="no-container-sm">
                                ...
                                <a href="/gangseo/pages/cancer/lung-2.php" class="basic-btn cancer no-body-lg fw600 no-mg-32--t">
                                    항암방사선 이어서 보기
