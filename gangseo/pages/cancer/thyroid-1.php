                        ...
                        <section class="no-cancer-sub-intro no-cancer-intro no-pd-48--y">
                            <div class="no-container-sm">
                                <hgroup class="--tac fade-up no-mg-24--b">
                                    <p class="no-body-lg fw300">생존율이 높다는데</p>
                                    <h2 class="no-heading-sm">왜 나는 불안할까?</h2>
                                </hgroup>
                                ...
                                <ul class="think-list list-js">
                                    ...
                                    <li class="--tac">
                                        <h3 class="no-body-lg fw600">목에 흉터가<br>
                                            너무 신경 쓰여요.</h3>
                        ...
                        <section class="no-cancer-sub-ba no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <div class="question no-body-md fw300 --tac fade-up">
                                    수술 전, 내 몸은 잘 준비됐을까?<br>
                                    수술 후, 어떻게 회복해야 할까?
                                </div>

                                <ul class="ba-list list-js no-mg-40--t">
                                    <li class="--tac">
                                        <span class="no-body-lg fw600">수술 전</span>
                                        <img src="/resource/images/icon/cancer-before-icon.svg" class="no-mg-16--y">
                                        <h3 class="no-body-lg fw600 no-mg-16--b">체력 관리</h3>

                                        <p class="no-body-md fw300 no-mg-4--b">기력강화</p>
                                        <p class="no-body-md fw300 no-mg-4--b">면역력 증진</p>
                                        <p class="no-body-md fw300">영양 식이 관리</p>
                                    </li>

                                    <li class="--tac">
                                        <span class="no-body-lg fw600">수술 후</span>
                                        <img src="/resource/images/icon/cancer-after-icon.svg" class="no-mg-16--y">
                                        <h3 class="no-body-lg fw600 no-mg-16--b">기력회복 및 재활</h3>

                                        <p class="no-body-md fw300 no-mg-4--b">수술 후유증 완화</p>
                                        <p class="no-body-md fw300 no-mg-4--b">기력 컨디션 회복</p>
                                        <p class="no-body-md fw300 no-mg-4--b">신체 기능 정상화</p>
                                        <p class="no-body-md fw300 no-mg-4--b">감염 관리</p>
                                    </li>
                                </ul>
                            </div>
                        </section>
                            ...
                            <ul class="disease-list">
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">목소리 변화 (음성 장애)</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            후두 신경(반회후두신경 또는 상후두신경)의 손상 또는 일시적 마비 → 발성 근육의 움직임 제한<br>
                                            <b class="fw600">증상</b><br>
                                            쉰 목소리, 목소리의 떨림 말할수록 목이 피로해짐 고음 발성 어려움
                                        </p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease15-1.jpg">
                                        </figure>

                                        <span class="no-body-md fw600">관리법</span>
                                        <p class="bullet no-body-md fw300">수술 후 1~3개월 내 대부분 회복됨 (일시적 마비)</p>
                                        <p class="bullet no-body-md fw300">3개월 이상 지속 시 음성치료 or 후두 성대 주사 고려</p>
                                        <p class="bullet no-body-md fw300">이비인후과 연계 및 정기 발성 평가 필요</p>
                                ...
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">저칼슘혈증 (손발 저림, 근육 경련)</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            부갑상선이 손상되거나 일시적으로 기능 저하 <br>→ 혈중 칼슘 감소<br>
                                            <b class="fw600">증상</b><br>
                                        </p>
                                        <p class="bullet no-body-md fw300">손발 끝 저림, 입 주변 감각 이상</p>
                                        <p class="bullet no-body-md fw300">근육 떨림, 쥐남</p>
                                        <p class="bullet no-body-md fw300">심한 경우 경련, 불안감, 심계항진</p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease15-2.jpg">
                                        </figure>

                                        <span class="no-body-md fw600">관리법</span>
                                        <p class="bullet no-body-md fw300">경증 : 칼슘 보충제(탄산칼슘) + 비타민 D 복용</p>
                                        <p class="bullet no-body-md fw300">중증 : 정맥 칼슘 주입</p>
                                        <p class="bullet no-body-md fw300">대부분 2주~3개월 내 회복, 일부는 장기 복용 필요</p>
                                ...
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">갑상선호르몬 부족 (T4 결핍)</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            갑상선 전절제술 후 체내 T4 분비 불가 <br>→ 외부 복용 필요<br>
                                            <b class="fw600">증상</b><br>
                                        </p>
                                        <p class="bullet no-body-md fw300">피로, 체중 증가, 무기력</p>
                                        <p class="bullet no-body-md fw300">피부 건조, 변비, 감정 기복</p>
                                        <p class="bullet no-body-md fw300">집중력 저하, 우울감</p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease15-3.jpg">
                                        </figure>

                                        <span class="no-body-md fw600">관리법</span>
                                        <p class="bullet no-body-md fw300">매일 아침 공복에 T4(레보티록신) 복용</p>
                                        <p class="bullet no-body-md fw300">정기적으로 TSH, Free T4 수치 확인 <br>→ 용량 조절</p>
                                        <p class="bullet no-body-md fw300">식사 30분 전 복용 / 철분·칼슘과 간격 유지</p>
                                ...
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">경부 흉터 및 미용 스트레스</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            목 정중앙 절개 흔적 → 특히 노출 많은 부위<br>
                                            <b class="fw600">증상</b><br>
                                        </p>
                                        <p class="bullet no-body-md fw300">흉터 돌출, 붉은 착색</p>
                                        <p class="bullet no-body-md fw300">미용 스트레스, 자존감 저하</p>
                                        <p class="bullet no-body-md fw300">계절·의상 선택 제한</p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease15-4.jpg">
                                        </figure>

                                        <span class="no-body-md fw600">관리법</span>
                                        <p class="bullet no-body-md fw300">수술 2주 후부터 흉터 연고, 테이프 사용</p>
                                        <p class="bullet no-body-md fw300">자외선 차단 철저</p>
                                        <p class="bullet no-body-md fw300">필요 시 레이저 치료 연계</p>
                                ...
                                <li class="updown-content">
                                    <a href="#" onclick="return false">
                                        <h3 class="no-body-lg fw600">삼킴 곤란 / 목 이물감</h3>

                                        <i class="fa-regular fa-angle-up i-24"></i>
                                    </a>
                                    <div class="content">
                                        <p class="no-body-md fw300"><b class="fw600">원인</b><br>
                                            목수술 부위 주변 연조직 유착 또는 부기<br>
                                            일시적 후두·인두 근육 약화<br>
                                            <b class="fw600">증상</b><br>
                                        </p>
                                        <p class="bullet no-body-md fw300">침 삼킬 때 목에 걸리는 느낌</p>
                                        <p class="bullet no-body-md fw300">목 조임감</p>
                                        <p class="bullet no-body-md fw300">음식 삼키기 불편함</p>

                                        <figure class="no-mg-16--y">
                                            <img src="/resource/images/cancer-disease15-5.jpg">
                                        </figure>

                                        <span class="no-body-md fw600">관리법</span>
                                        <p class="bullet no-body-md fw300">부드럽고 따뜻한 음식 위주 식사</p>
                                        <p class="bullet no-body-md fw300">1~2개월 후 대부분 호전됨</p>
                                        <p class="bullet no-body-md fw300">지속 시 연하 기능 검사 및 재활운동 병행</p>
                        ...
                        <section class="no-cancer-sub-care no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <ul class="care-list fade-up">
                                    <li class="mini-modal">
                                        <a href="#" onclick="return false">
                                            <h3 class="no-body-lg fw600">일상 관리</h3>
                                            <i class="fa-regular fa-angle-up fa-rotate-90 i-24"></i>

                                            <img src="/resource/images/icon/cancer-care7.svg">
                                        </a>
                                            ...
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card27-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card27-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card27-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card27-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card27-5.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card27-6.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li class="mini-modal">
                                        ...
                                        <div class="mini-modal-wrap">
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card28-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card28-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card28-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card28-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card28-5.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card28-6.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li class="mini-modal">
                                        ...
                                        <div class="mini-modal-wrap">
                                            <div class="modal-slider">
                                                <ul class="swiper-wrapper">
                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-1.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-2.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-3.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-4.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-5.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-6.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-7.jpg">
                                                    </li>

                                                    <li class="swiper-slide">
                                                        <img src="/resource/images/card/cancer-card2-8.jpg">
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <ul class="heal-list no-mg-32--t">
                                ...
                                <li class="updown-content">
                                    ...
                                    <div class="content v2 v3">
                                        ...
                                        <a href="/gangseo/pages/cancer/thyroid-4.php" class="basic-btn cancer no-body-lg fw600 no-mg-16--t">
                                            항암식이 바로가기
                                        </a>
                                    </div>
                                </li>
