            ...
            <div class="visual-wrap">
                ...
                <div class="mobile-visual-wrap">
                    ...
                    <div class="no-cancer-sub">
                        <section class="no-cancer-sub-relapse no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <div class="speech-wrap">
                                    <img src="/resource/images/relapse-speech3.png" <?= $aos_right_slow ?>>
                                    <img src="/resource/images/relapse-speech4.png" <?= $aos_left_slow ?>>
                                </div>
                                ...
                                <div class="relapse-percent no-mg-48--t">
                                    <h3 class="no-body-xxl fw600 --tac fade-up">갑상선암 재발률</h3>

                                    <ul class="no-mg-16--t fade-up">
                                        <li class="--tac">
                                            <p class="no-body-sm fw600 no-mg-4--b">최대</p>
                                            <div class="f-wrap brown"><b class="counter no-heading-lg" data-count="50"></b><span class="no-body-lg fw600">%</span></div>
                                            <h4 class="no-body-sm fw300 no-mg-8--t">평균 재발시기<br> 8.1년</h4>
                                        </li>

                                        <li class="--tac">
                                            <p class="no-body-sm fw600 no-mg-4--b">최대</p>
                                            <div class="f-wrap brown"><b class="counter no-heading-lg" data-count="75"></b><span class="no-body-lg fw600">%</span></div>
                                            <h4 class="no-body-sm fw300 no-mg-8--t">20년 이후<br>
                                                사망비율</h4>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <section class="no-cancer-sub-test v2 no-pd-48--y">
                            <div class="no-container-sm">
                                <h2 class="no-heading-sm --tac">정기적인 예방 검사를 통해<br>
                                    재발 여부를 체크하세요.</h2>
                        ...
                        <section class="no-cancer-sub-danger no-pd-48--y">
                            <div class="no-container-sm">
                                <hgroup class="--tac fade-up">
                                    <h2 class="no-heading-sm">언제까지 관리해야 하나요?</h2>
                                </hgroup>
                                ...
                                <strong class="no-body-md fw600 --tac fade-up">매년 정기검진으로 상태를 확인하고,<br>
                                    면역력 관리도 꾸준히 하는 게 좋아요. </strong>

                                <strong class="no-body-md fw600 --tac no-mg-16--t fade-up">면력 의료진과 함께
                                    <b class="brown">장기적인 건강 계획을 세워보세요.</b></strong>

                                <ul class="danger-list no-mg-32--t">
                                    <li class="--tac fade-up">
                                        <p class="no-body-md fw300">갑상선 피막 침범 시</p>
                                        <h3 class="no-body-xxl fw600">재발률 89.5%<br> <b class="brown">사망률 13.8%</b>
                                        </h3>
                                    </li>

                                    <li class="--tac fade-up">
                                        <p class="no-body-md fw600">원격전이가 있을 시</p>
                                        <h3 class="no-body-xxl fw600">재발률 90%<br> <b class="brown">사망률 70%</b>
                                        </h3>
                                    </li>
                                </ul>
                            </div>
