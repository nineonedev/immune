                    ...
                    <div class="no-rehab-sub no-herb">
                        ...
                        <div class="herb-form product-inquiry">
                            <div class="top-wrap no-pd-48--t">
                                ...
                                <h2 class="no-heading-sl --tac">경옥고 상담신청</h2>
                            </div>
                            ...
                            <div class="no-container-sm">
                                ...
                                <form id="herbForm" name="herbForm" method="post">
                                    <fieldset>
                                        ...
                                        <input type="hidden" id="inquiry_subject" name="inquiry_subject" value="경옥고 상담신청">
                        ...
                        <section class="no-cancer-visual hospital first herb">
                            <nav class="herb-nav">
                                <ul class="nav-list">
                                    ...
                                    <li>
                                        <a href="/pages/herb/gyeongok.php" class="no-body-md fw300 wgray active">경옥고</a>
                                    </li>

                                    <li>
                                        <a href="/pages/herb/joint.php" class="no-body-md fw300 wgray">관절고</a>
                                    </li>
                                </ul>
