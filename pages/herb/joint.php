...
<script src="<?= $ROOT ?>/resource/js/herb.js?v=<?= date('YmdHis') ?>" defer></script>
<!-- css, js  -->
                    ...
                    <div class="no-rehab-sub no-herb">
                        ...
                        <div class="herb-form product-inquiry">
                            <div class="top-wrap no-pd-48--t">
                                ...
                                <h2 class="no-heading-sl --tac">관절고 상담신청</h2>
                            </div>
                            ...
                            <div class="no-container-sm">
                                ...
                                <form id="herbForm" name="herbForm" method="post">
                                    <fieldset>
                                        ...
                                        <input type="hidden" id="inquiry_subject" name="inquiry_subject" value="관절고 상담신청">
                        ...
                        <section class="no-cancer-visual hospital first herb">
                            <nav class="herb-nav">
                                <ul class="nav-list">
                                    <li>
                                        <a href="/pages/herb/gongjin.php" class="no-body-md fw300 wgray">공진단</a>
                                    </li>

                                    <li>
                                        <a href="/pages/herb/gyeongok.php" class="no-body-md fw300 wgray">경옥고</a>
                                    </li>

                                    <li>
                                        <a href="/pages/herb/joint.php" class="no-body-md fw300 wgray active">관절고</a>
                                    </li>
                                </ul>
                            ...
                            <div class="no-container-sm">
                                <hgroup class="fade-up">
                                    <h2 class="no-heading-sm no-mg-16--b">과학으로 증명된<br>
                                        3중 관절 케어 시스템</h2>
                                    <p class="no-body-md fw300">관절 통증 개선, 연골 재생의 혁신<br> 엄선된 9가지 프리미엄 약재의 과학적 조화<br> 지금 경험하세요.</p>
                                </hgroup>
