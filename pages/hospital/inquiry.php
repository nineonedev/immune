                    ...
                    <div class="no-cancer no-neuro no-rehab no-inquiry">
                        <section class="no-inquiry-wrap no-pd-48--y">
                            <div class="no-container-sm">
                                ...
                                <form id="frm" name="frm" method="post" class="fade-up no-mg-48--t" style="opacity: 1;">
                                    <input type="hidden" name="mode" id="mode" value="inquiry_simple">
                                    ...
                                    <fieldset>
                                        <ul class="form-wrap">
                                            ...
                                            <li class="input-wrap">
                                                <div class="f-wrap">
                                                    <p class="no-body-lg fw600">지점 선택<b class="error fw300">*</b></p>
                                                </div>
                                                <div class="radio-group-wrap">
                                                    <div class="radio-select">
                                                        <p>지점을 선택해주세요</p>
                                                        <i class="fa-regular fa-angle-down i-24" aria-hidden="true"></i>
                                                    </div>
                                            ...
                                            <li class="input-wrap">
                                                <div class="f-wrap">
                                                    ...
                                                    <h6 class="no-body-xs"><b class="error">*</b> 표기된 항목은 필수입력 항목입니다.
                                                    </h6>
                                                </div>
                                            ...
                                            <li class="input-wrap">
                                                <div class="f-wrap">
                                                    ...
                                                    <h6 class="no-body-xs"><b class="blue fw600">전화상담 가능 시간</b> 평일 10:00
                                                        - 18:00</h6>
                                                </div>
                                                <div class="radio-group-wrap">
                                                    <div class="radio-select">
                                                    ...
                                                    <div class="radio-list">
                                                        <?php foreach ($consult_time_options as $key => $label): ?>
                                                        <label>
                                            ...
                                            <li class="input-wrap">
                                                ...
                                                <div class="radio-group-wrap">
                                                    ...
                                                    <div class="radio-list">
                                                        <?php foreach ($hope_treatments as $key => $label): ?>
                                                        <label>
                                                            <input type="radio" name="hope_treatment"
                                            ...
                                            <div class="check-list no-mg-6--t">
                                                <figure>
                                                    <input type="checkbox" name="private_check" id="private_check"
                                                        class="check">
                                                    <label for="private_check"><i
                                                            class="fa-sharp fa-solid fa-square-check"></i></label>
                                                    <label for="private_check" class="no-body-xs fw300">개인정보 취급방침에
                                                        동의합니다. (필수)</label>
                                                ...
                                                <figure>
                                                    <input type="checkbox" name="marketing_check" id="marketing_check"
                                                        class="check">
                                                    <label for="marketing_check"><i
                                                            class="fa-sharp fa-solid fa-square-check"></i></label>
                                                    <label for="marketing_check" class="no-body-xs fw300">마케팅 (이벤트 정보수신
                                                        등) 사용 동의 (선택)</label>
                                                </figure>
                                            </div>
                                        </div>
                                        ...
                                        <!-- 제출 버튼 -->
                                        <button type="submit" class="submit no-body-lg fw600 no-mg-20--t">
                                            제출하기
                                        </button>
                                    </fieldset>
                                </form>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const requestUrl = "/module/ajax/request.process.php";
    ...
    form.addEventListener("submit", async (e) => {
        ...
        // 필수 체크
        const requiredFields = ["branch_id", "name", "phone", "private_check"];
