                                ...
                                <ul class="find-list no-mg-24--b">
                                    ...
                                    <li>
                                        ...
                                        <a href="../member/find_id.php"
                                            class="no-member-btn no-body-md --tac active">아이디 찾기</a>

                                    </li>

                                    <li>

                                        <a href="../member/find_pwd.php" class="no-member-btn no-body-md --tac">비밀번호
                                            찾기</a>
...
const API_URL = '/module/ajax/find_id.php';
...
const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (result.success) {
            // 아이디 찾기 성공 시 user-info div에 정보 표시
            userInfoDiv.innerHTML = `<strong>아이디:</strong> ${result.user_id}`;
