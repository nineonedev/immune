                                    ...
                                    <fieldset>
                                        <ul class="form-wrap">
                                            <li class="input-wrap">
                                                ...
                                                <div class="id-check-wrap">
                                                    ...
                                                    <a href="#" class="check-btn no-body-xs fw600">
                                                        중복확인
                                                    </a>
                                                </div>
                                            </li>
                                            ...
                                            <li class="input-wrap">
                                                ...
                                                <input type="tel" name="user_phone" id="user_phone" class="no-input" placeholder="숫자만 입력해 주세요.">
                                            </li>
                                            ...
                                            <li class="input-wrap">
                                                ...
                                                <input type="email" name="user_email" id="user_email" class="no-input" placeholder="예시) example@email.com">
                                            </li>
                                            ...
                                            <li class="input-wrap">
                                                ...
                                                <input type="tel" name="user_birth" id="user_birth" class="no-input" placeholder="예시) 20250101">
                                            </li>
                                        </ul>
                                        ...
                                        <div class="form-bottom no-mg-16--t">
                                            <div class="check-list">
                                                <figure>
                                                    <input type="checkbox" name="email_check" id="email_check" class="check">
                                                    <label for="email_check"><i class="fa-sharp fa-solid fa-square-check"></i></label>
                                                    <label for="email_check" class="no-body-xs fw300">공지 등 문자 수신에 동의합니다.(선택)</label>
                                                </figure>
                                                ...
                                                <figure>
                                                    <input type="checkbox" name="terms_check" id="terms_check" class="check">
                                                    <label for="terms_check"><i class="fa-sharp fa-solid fa-square-check"></i></label>
                                                    <label for="terms_check" class="no-body-xs fw300">이용약관에 동의합니다. (필수)</label>
                                        ...
                                        <button type="button" onclick="doSignUp();" class="submit no-body-lg fw600 no-mg-16--t">
                                            회원가입
                                        </button>
                                    </fieldset>
                                </form>
