                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <select name="skin" id="skin">
                                            ...
                                            ?>
                                            <option value="<?=$key?>" <? if($data[skin] == $key) echo "selected";?>><?=$val?></option>
                                            <?
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="no-admin-content">
                                        <? if($data[top_banner_image]){?>
                                            <div class="no-banner-image">
                                                <img
                                                    src="<?=$UPLOAD_WDIR_BOARD?>/<?=$data[top_banner_image]?>"
                                                    alt="<?=$data[title].' 상단 이미지'?>"
                                                />
                                            </div>
                                        <? } ?>
                                        ...
                                        <div class="no-radio-form">
                                            <label for="view_yn1">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="view_yn" id="view_yn1" value="Y" <? if($data[view_yn] == "Y") echo "checked";?>>
                                                    <span>
                                            ...
                                            <label for="view_yn2">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="view_yn" id="view_yn2" value="N" <? if($data[view_yn] == "N") echo "checked";?>>
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="no-admin-content">
                                        <div class="no-radio-form">
                                            <label for="secret_yn1">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="secret_yn" id="secret_yn1" value="Y" <? if($data[secret_yn] == "Y") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <label for="secret_yn2">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="secret_yn" id="secret_yn2" value="N"  <? if($data[secret_yn] == "N") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="no-admin-content">
                                        <div class="no-radio-form">
                                            <label for="comment_yn1">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="comment_yn" id="comment_yn1" value="Y" <? if($data[comment_yn] == "Y") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <label for="comment_yn2">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="comment_yn" id="comment_yn2" value="N" <? if($data[comment_yn] == "N") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="no-admin-content">
                                        <div class="no-radio-form">
                                            <label for="category_yn1">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="category_yn" id="category_yn1" value="Y" <? if($data[category_yn] == "Y") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <label for="category_yn2">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="category_yn" id="category_yn2" value="N" <? if($data[category_yn] == "N") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="no-admin-content">
                                        <div class="no-radio-form">
                                            <label for="depth_category_yn1">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="depth_category_yn" id="depth_category_yn1" value="Y" <? if($data[depth_category_yn] == "Y") echo "checked";?>>
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <label for="depth_category_yn2">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="depth_category_yn" id="depth_category_yn2" value="N" <? if($data[depth_category_yn] == "N") echo "checked";?>>
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="no-admin-content">
                                        <div class="no-radio-form">
                                            <label for="fileattach_yn1">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="fileattach_yn" id="fileattach_yn1" value="Y" onClick="doAttrChange('fileattach_cnt', 'disabled', false);" <? if($data[fileattach_yn] == "Y") echo "checked";?>>
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <label for="fileattach_yn2">
                                                <div class="no-radio-box">
                                                    <input type="radio" name="fileattach_yn" id="fileattach_yn2" value="N" onClick="doAttrChange('fileattach_cnt', 'disabled', true);" <? if($data[fileattach_yn] == "N") echo "checked";?> >
                                                    <span>
                                                        <i class="bx bx-radio-circle-marked"></i>
                                                    </span>
                                                </div>
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <select name="fileattach_cnt" id="fileattach_cnt" disabled>
                                            ...
                                            <option value="1" <? if($data[fileattach_cnt] == "1") echo "selected";?>>1개</option>
                                            <option value="2" <? if($data[fileattach_cnt] == "2") echo "selected";?>>2개</option>
                                            <option value="3" <? if($data[fileattach_cnt] == "3") echo "selected";?>>3개</option>
                                            <option value="4" <? if($data[fileattach_cnt] == "4") echo "selected";?>>4개</option>
                                            <option value="5" <? if($data[fileattach_cnt] == "5") echo "selected";?>>5개</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- admin-block -->
								...
								<div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <input
                                            ...
                                            class="no-input--detail"
                                            placeholder="추가필드<?=$i?>"
											value="<?=$data["extra_match_field{$i}"]?>"
                                        />
                                    </div>
                                </div>	
								<?
