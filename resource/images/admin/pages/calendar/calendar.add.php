...
<body>
    <div class="no-wrap">
                                    ...
                                    <div class="no-admin-content">
                                        ...
                                        >
                                           ...
                                           <?
												...
												$num++;
											?>
											<option value="<?=$v['no']?>"><?=$v['name']?></option>
											<?
												}
											?>
                                        </select>
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <input
                                            ...
                                            id="c_date"
                                            class="no-input--detail"
											data-alert="날짜를 선택해주세요" data-require="true"
                                        />
                                    </div>
                                </div>
                                <!-- admin-block -->
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <input
                                            ...
                                            id="title"
                                            class="no-input--detail"
											data-alert="제목을 입력해주세요" data-require="true"
                                        />
                                    </div>
                                </div>
                                <!-- admin-block -->
        ...
        <!-- Footer -->
        <script type="text/javascript" src="./js/calenadr.process.js?c=<?=$STATIC_ADMIN_JS_MODIFY_DATE?>"></script>
        <?
