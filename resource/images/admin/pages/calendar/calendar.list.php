...
<?
	...
	$query = " select count(*)  as cnt from nb_academic_calendar a  $mainqry ";
            ...
            <input type="hidden" name="mode" id="mode" value="">
                <section class="no-content">
                    ...
                    <div class="no-toolbar">
                        <div class="no-toolbar-container no-flex-stack">
                            <div class="no-page-indicator">
                                <h1 class="no-page-title">Calendar 관리</h1>
                            ...
                            <div class="no-items-center">
                                <a href="./calendar.add.php" class="no-btn no-btn--main no-btn--big"> 일정 등록 </a>
                            </div>
                        </div>
                    </div>
                    <!-- Search -->
                    <div class="no-search no-toolbar-container">
                        <div class="no-card">
                            <div class="no-card-header">
                                <h2 class="no-card-title">Calendar 검색</h2>
                            </div>
                                ...
                                <div class="no-admin-block wide">
                                    ...
                                    <div class="no-search-select">
                                        <select name="searchColumn" id="searchColumn">
                                            ...
                                            <option value="a.title" <? if($searchColumn == "a.title") echo "selected";?>>제목</option>
                                            <option value="a.contents" <? if($searchColumn == "a.contents") echo "selected";?>>내용</option>
                                        </select>
                    ...
                    <div class="no-content-container">
                        <div class="no-card">
                            <div class="no-card-header">
                                <h2 class="no-card-title">Calendar 목록</h2>
                            </div>
                                    ...
                                    <table class="no-table">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="no-min-width-150" width="*">
                                                    제목
                                                </th>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <a href="./calendar.view.php?no=<?=$v[no]?>">
                                                        <?=$v['campus_name']?>
                                                    </a>
                                                </td>
												<td>
                                                ...
                                                <td>
                                                    <div class="no-table-role">
                                                        ...
                                                        <div class="no-table-action">
                                                            ...
                                                            <!-- <a
                                                                href="./calendar.view.php?no=<?=$v[no]?>"
