...
<?
	...
	if($searchColumn && $searchKeyword) {
		$mainqry .=  " and  ( ( replace(a.title,' ','') like '%".trim($searchKeyword)."%' )  or  ( replace(a.contents,' ','') like '%".trim($searchKeyword)."%' ) )";
	 }
	...
	$query = " select count(*)  as cnt from nb_request a  $mainqry ";
	...
	$query = " select a.no, a.name, a.phone, a.contents, a.regdate
						from nb_request a
                                    ...
                                    <table class="no-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./request.view.php?no=<?=$v[no]?>">
                                                        <?=$v[name]?>
                                                    </a>
                                                </td>
