                ...
                <section class="no-content">
                    ...
                    <div class="no-card">
                            ...
                            >
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        <input
                                            ...
                                            id="hp"
                                            class="no-input--detail"
                                            placeholder="Professor. Room 연락처"
                                            value="<?=$SITEINFO_HP?>"
                                        />
                                    </div>
                                </div>
                                ...
                                <div class="no-admin-block">
                                    <h3 class="no-admin-title">
                                        <label for="email">Professor. Room 이메일</label>
                                    </h3>
                                    <div class="no-admin-content">
                                        <input
                                            type="text"
                                            ...
                                            id="email"
                                            class="no-input--detail"
                                            placeholder="Professor. Room 연락처 이메일"
